...
func (operation *Operation_Init) Init_Demo_Run(flags []string) (bool, map[string]string) {
  key := "wunder"
  if len(flags)>0 {
    key = flags[0]
    flags = flags[1:]
  ...
  switch key {
    case "lamp":
      return true, operation.Init_Demo_Lamp()
    case "starter":
      return true, operation.Init_Demo_Scale()
    case "drupal":
      return true, operation.Init_Demo_Drupal()
    case "wunder":
      return true, operation.Init_Demo_Wunder()
  }
...
func (operation *Operation_Init) Init_Demo_Lamp() map[string]string {
  return map[string]string{
    "app/www/active/index.php":  `<?php phpinfo();`,
    "app/README.md":  `
## DEMO: Lamp project

This is a demo LAMP project, configured using "coach init"

Override the following default content:

/app/www/active/index.php : put a real PHP root in here

`,   
  }
}

func (operation *Operation_Init) Init_Demo_Scale() map[string]string {
  return map[string]string{
    "app/www/active/index.php":  `<?php phpinfo();`,
    "app/README.md":  `
## DEMO: Lamp project
...
func (operation *Operation_Init) Init_Demo_Drupal() map[string]string {
  return map[string]string{
...
www:
  ...
  Config:
    ...
    Domainname: "%CONTAINER_DOMAIN"                 # Token : can be set in conf.yml:Tokens
    Env:
...
func (operation *Operation_Init) Init_Demo_Wunder() map[string]string {
  return map[string]string{
    ".coach/conf.yml":  `Project: coach
#Author: Used for docker commits
